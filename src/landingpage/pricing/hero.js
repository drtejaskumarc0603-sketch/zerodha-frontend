        ...
        <div className="container ">
            ...
            <div className="row text-center">
                <div className="col-4 p-4 ">
                    <img src="/media/Colab Notebooks/pricingEquity.svg"  alt="equity"/>
                    <h1>Free equity delivery</h1>
                    <p className="text-muted">All equity delivery investments (NSE, BSE), are absolutely free — ₹ 0 brokerage.</p>
                </div>
                <div className="col-4 p-4">
                    <img src="/media/Colab Notebooks/intradayTrades.svg" alt="intrades" />
                    <h1>Intraday and F&O trades</h1>
                    <p className="text-muted">Flat ₹ 20 or 0.03% (whichever is lower) per executed order on intraday trades across equity, currency, and commodity trades. Flat ₹20 on all option trades.</p>
                </div>
                <div className="col-4 p-4">
                    <img src="/media/Colab Notebooks/pricingEquity.svg"  alt="prequity"/>
