        ...
        <div className="container">
            <div className="row p-5 mb-5 mt-5">
                <h1 className="fs-2 text-center">
                    We Pioneered the discount broking model in India <br />and have been at the forefront of innovation ever since.
                </h1>
            </div>
            <div className="row p-5 mt-5 border-top text-muted " style={{ lineHeight:"1.8" , fontSize:"1.1rem"}}>
                <div className="col-6 p-5">
                    ...
                    <p>Today, our disruptive pricing models and in-house technology have made us the biggest stock broker in India.</p>p
